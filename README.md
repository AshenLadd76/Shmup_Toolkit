...
- **GPU Instancing Ready** – Designed with GPU instancing in mind, making high-volume projectile rendering straightforward (implementation pending).  
- **Pattern Generator Tool** – Work-in-progress editor tool that lets developers compose bullet patterns modularly, like building with Lego blocks.  
